...
public abstract class CoreComplexCommand extends CoreCommand implements ComplexCommandComponent {
	...
	@Override
	public final void onExecute(@NotNull CommandSender sender, @NotNull String alias, String[] args) {
		onExecute(sender, alias, args, new ArrayList<>(Arrays.asList(args)));
	...
	@Override
	public final List<String> onComplete(@NotNull CommandSender sender, @NotNull String alias, String[] args, Location loc) {
	...
	public List<String> onComplete(CommandSender sender, String alias, String[] args, Location loc,
		...
		if (params.size() == 1)
			return this.complete(params.get(0), subCommands.values(), t -> t.getName(), new Predicate<CoreComplexSubCommand>() {
