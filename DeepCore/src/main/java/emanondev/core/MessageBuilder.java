...
public class MessageBuilder {
	 ...
	 * 
	 * @param text       text to add (each string is a line)
	 * @param papiTarget target for papi placeholder, if null attemp to use language
	...
	public MessageBuilder addFullComponentTranslation(String path, String defText, List<String> defHover,
		...
		return addFullComponentTranslation(path, Arrays.asList(defText), defHover, defAction, defClickAction, null,
				true, holders);
	}
	 ...
	 * @param defClickAction default click action type
	 * @param color          should replace colors? by default true
	 * @param papiTarget     target for papi placeholder, if null attemp to use
	...
	public MessageBuilder addFullComponentTranslation(String path, String defText, List<String> defHover,
		...
		return addFullComponentTranslation(path, Arrays.asList(defText), defHover, defAction, defClickAction,
	...
	public MessageBuilder addFullComponentTranslation(String path, String defText, String defHover, String defAction,
		...
		return addFullComponentTranslation(path, Arrays.asList(defText), Arrays.asList(defHover), defAction,
	...
	public MessageBuilder addFullComponentTranslation(String path, List<String> defText, String defHover,
			String defAction, ClickEvent.Action defClickAction, String... holders) {
		return addFullComponentTranslation(path, defText, Arrays.asList(defHover), defAction, defClickAction, null,
				true, holders);
	}
	...
	public MessageBuilder addFullComponentTranslation(String path, List<String> defText, String defHover,
			String defAction, ClickEvent.Action defClickAction, Player papiTarget, boolean color, String... holders) {
		return addFullComponentTranslation(path, defText, Arrays.asList(defHover), defAction, defClickAction,
				papiTarget, color, holders);
	}
