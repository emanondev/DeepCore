...
public interface ReadUtility {
	 ...
	 */
	@Deprecated
	public default @Nullable Player readPlayer(@NotNull String arg) {
	 ...
	 * @return target player or null if player is offline or vanished
	 */
	public default @Nullable Player readPlayer(CommandSender sender,@NotNull String arg) {
		Player p = Bukkit.getPlayer(arg);
		if (p==null)
			return null;
		if (Hooks.isVanishEnabled()) {
	 ...
	 */
	public default @Nullable OfflinePlayer readOfflinePlayer(@NotNull String arg) {
	 ...
	 */
	public default @Nullable Integer readInt(@NotNull String arg) {
		try {
	 ...
	 */
	public default @Nullable Double readDouble(@NotNull String arg) {
		try {
