...
public abstract class ListGui<T> extends ChestGui implements PagedGui {
	 ...
	 * @param plugin
	 */
	public ListGui(String title, int rows, Player p, Gui previusHolder, CorePlugin plugin) {
		this(title, rows, p, previusHolder, plugin,false,1);
	}
	/**
	 * This implementation uses the last row for pages buttons, those buttons won't
	 * change position changing gui page
	 ...
	 * @param page
	 */
	public ListGui(String title, int rows, Player p, Gui previusHolder, CorePlugin plugin, boolean timerUpdate,
			int page) {
	...
	public void sort(Comparator<T> comparator) {
		Collections.sort(buttons, new Comparator<ContainerButton>() {
			@Override
			public int compare(ListGui<T>.ContainerButton o1, ListGui<T>.ContainerButton o2) {
