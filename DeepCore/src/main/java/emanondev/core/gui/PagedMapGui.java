...
public class PagedMapGui extends ChestGui implements PagedGui {
	 ...
	 * @param plugin
	 */
	public PagedMapGui(String title, int rows, Player p, Gui previusHolder, CorePlugin plugin) {
		this(title, rows, p, previusHolder, plugin, false,0);
	}
	 ...
	 * @param page
	 */
	public PagedMapGui(String title, int rows, Player p, Gui previusHolder, CorePlugin plugin, int page) {
		this(title, rows, p, previusHolder, plugin, false,0);
	}
	/**
	 * This implementation uses the last row for pages buttons, those buttons won't
	 ...
	 * @param timerUpdate
	 */
	public PagedMapGui(String title, int rows, Player p, Gui previusHolder, CorePlugin plugin, boolean timerUpdate) {
		this(title, rows, p, previusHolder, plugin, timerUpdate,0);
	}
