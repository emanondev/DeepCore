...
public class ResearchFButton<T> extends AGuiButton {
	...
	private BiFunction<String, T, Boolean> match;
	private BiFunction<InventoryClickEvent, T, Boolean> elementClick;
	private Function<T, ItemStack> elementItem;
	private Supplier<Collection<T>> getElements;
	...
	public boolean defaultOnClick(InventoryClickEvent event) {
		if (event.getClick() != ClickType.LEFT)
			return false;
		AdvancedResearchGui<T> gui = new AdvancedResearchGui<T>("Research",
	...
	private HashMap<Integer, Function<Gui, GuiButton>> cButtons = new HashMap<>();
