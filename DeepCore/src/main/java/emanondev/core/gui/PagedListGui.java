...
public abstract class PagedListGui<T> extends ChestGui implements PagedGui {
	 ...
	 * @param page
	 */
	public PagedListGui(String title, int rows, Player p, Gui previusHolder, CorePlugin plugin, boolean timerUpdate,
			int page) {
	...
	public void sort(Comparator<T> comparator) {
		Collections.sort(buttons, new Comparator<ContainerButton>() {
			@Override
			public int compare(PagedListGui<T>.ContainerButton o1, PagedListGui<T>.ContainerButton o2) {
