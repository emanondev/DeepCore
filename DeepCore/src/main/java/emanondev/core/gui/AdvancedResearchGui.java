...
public abstract class AdvancedResearchGui<T> extends AnvilGui implements PagedGui {
	...
	private int page;
	private final List<ContainerButton> buttons = new ArrayList<ContainerButton>();
	private final List<ContainerButton> activeButtons = new ArrayList<ContainerButton>();
	private Predicate<T> show;
	private PlayerSnapshot snap = new PlayerSnapshot();
	 ...
	 * @param plugin
	 */
	public AdvancedResearchGui(String title, ItemStack base, Player player, Gui previusHolder,
			@NotNull CorePlugin plugin) {
		this(title, base,player, previusHolder, plugin, false);
	}
	...
	public AdvancedResearchGui(String title, ItemStack base, Player player, Gui previusHolder,
		...
		super(title, player, previusHolder, plugin, isTimerUpdated);
	...
	public void sort(Comparator<T> comparator) {
		Collections.sort(buttons, new Comparator<ContainerButton>() {
			@Override
			public int compare(AdvancedResearchGui<T>.ContainerButton o1, AdvancedResearchGui<T>.ContainerButton o2) {
	...
	public InventoryView getView() {
		...
		if (viewer == null || !(viewer instanceof Player))
			return null;
