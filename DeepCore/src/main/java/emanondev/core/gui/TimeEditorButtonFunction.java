...
public class TimeEditorButtonFunction extends AGuiButton {
	...
	private long[] ranges = new long[]{1L,10L,60L,600L,3600L,6*3600L,24*3600L,7*24*3600L,4*7*24*3600L,54*7*24*3600L};

	/**
	 * 
	 * @param gui              parent gui
	 * @param grabValue        Suppy the current value
	...
	public boolean onClick(InventoryClickEvent event) {
		...
		case LEFT: {
			Long old = getValue();
			changeRequest((Long) addNumbers(old, getChangeAmount()));
	...
	private Function<Long, List<String>> baseDescription = null;
	private BiFunction<Long, Long, List<String>> fullDescription = null;
	 ...
	 * @return
	 */
	public TimeEditorButtonFunction setBaseDecription(Function<Long, List<String>> baseDescription) {
		return this;
	}

	public TimeEditorButtonFunction setFullDecription(BiFunction<Long, Long, List<String>> fullDescription) {
		return this;
	}
	...
	public ItemStack getItem() {
		...
		info.addAll(this.getLanguageSection(getTargetPlayer()).loadStringList("timeEditorFull",
